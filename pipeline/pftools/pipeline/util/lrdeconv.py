# Taken from MERlin:
# https://github.com/ZhuangLab/MERlin/blob/be3c994ef8fa97fbd3afb85705d8ddbed12118cf/merlin/util/deconvolve.py
# and
# https://github.com/ZhuangLab/MERlin/blob/be3c994ef8fa97fbd3afb85705d8ddbed12118cf/merlin/util/matlab.py
...
def calculate_projectors(windowSize: int, sigmaG: float) -> list:
    ...
    """
    pf = matlab_gauss2D(shape=(windowSize, windowSize),
                               sigma=sigmaG)
...
def deconvolve_lucyrichardson(image: np.ndarray,
    ...
    if windowSize % 2 != 1:
        gaussianFilter = matlab_gauss2D(shape=(windowSize, windowSize),
                                               sigma=sigmaG)
